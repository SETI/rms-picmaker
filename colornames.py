...
# Extracted from /usr/X11/share/X11/rgb.txt
    ...
    def lookup(name):
        ...
        try:
            return ColorNames.COLOR_NAME_DICT[test]
        except KeyError:
            pass

        # Try it as lower case
        test = test.lower()
        try:
            return ColorNames.COLOR_NAME_LOWER_DICT[test]
        except KeyError:
            pass

        # Try it as lower case, without blanks, dashes or underscores
